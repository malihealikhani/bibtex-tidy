...
(function (global, factory) {
	...
	var options = [
		...
		},
		{
			...
			cli: 'curly',
			description:
				'Enclose values in curly braces - Enclose all property values in braces. Quoted values will be converted to braces. For example, "Journal of Tea" will become {Journal of Tea}.',
			examples: [],
			type: 'boolean',
		},
		{
			...
			cli: 'numeric',
			description:
				'Use numeric values where possible - Strip quotes and braces from numeric/month values. For example, {1998} will become 1998.',
			examples: [],
			type: 'boolean',
		},
		{
			...
			cli: 'space',
			description:
				'Indent with spaces - Prefix all fields with the specified number of spaces (ignored if tab is set).',
		...
		},
		{
			...
			cli: 'merge',
			description:
				'Merge duplicate entries - Two entries are considered duplicates in the following cases: (a) their DOIs are identical, (b) their abstracts are identical, or (c) their authors and titles are both identical. The firstmost entry is kept and any extra properties from duplicate entries are incorporated.',
			examples: [
		...
		},
		{
			...
			cli: 'merge-strategy',
			description:
				'Merge strategy - How duplicate entries should be merged. - first: only keep the original entry - last: only keep the last found duplicate - combine: keep original entry and merge in fields of duplicates if they do not already exist - overwrite: keep original entry and merge in fields of duplicates, overwriting existing fields if they exist',
			examples: [],
			type: 'any',
		},
		{
			...
			description:
				'Strip double-braced values - Where an entire value is enclosed in double braces, remove the extra braces. For example, {{Journal of Tea}} will become {Journal of Tea}.',
			examples: [],
			type: 'boolean',
		},
		{
			...
			cli: 'drop-all-caps',
			description:
				'Drop all caps - Where values are all caps, make them title case. For example, {JOURNAL OF TEA} will become {Journal of Tea}.',
			examples: [],
			type: 'boolean',
		},
		{
			...
			cli: 'escape',
			description:
				'Escape special characters - Escape special characters, such as umlaut. This ensures correct typesetting with latex.',
		...
		},
		{
			...
			cli: 'sort-fields',
			description:
				'Sort fields - Sort the fields within entries. The default sort order is XXX. Alternatively, you can specify field names delimed by spaces or commas.',
				...
				(function () {
					...
					function peg$parse(input, options) {
						...
						var peg$FAILED = {},
							...
							peg$c1 = peg$otherExpectation(
								'preamble, entry, string, or comment'
							),
						...
						function peg$parseENTRY() {
							...
							if (s1 !== peg$FAILED) {
								...
								if (s3 === peg$FAILED) {
									...
									if (s3 === peg$FAILED) {
										if (
											input.substr(peg$currPos, 6).toLowerCase() === peg$c42
										) {
				...
				let items = parse(str, options),
					...
					evaluate = (datatype, value) => {
						if (datatype === 'number') {
							...
							return stripMatchingBraces(value).replace(
								/\\(["'%@{}()_])/g,
								'$1'
							); // unescape characters
		...
		for (const item of items) {
			...
			for (const [key, merge] of uniqCheck) {
				...
				switch (key) {
					...
					case 'doi':
						const doi = alphaNum(
							(_a = item.fieldMap.get('doi')) === null || _a === void 0
								? void 0
								: _a.value
						);
						if (!doi) continue;
					...
					case 'citation':
						const ttl =
							(_b = item.fieldMap.get('title')) === null || _b === void 0
								? void 0
								: _b.value;
						const aut =
							(_c = item.fieldMap.get('author')) === null || _c === void 0
								? void 0
								: _c.value;
						if (!ttl || !aut) continue;
						const cit =
							...
							':' +
							((_d = alphaNum(ttl)) === null || _d === void 0
								? void 0
								: _d.slice(0, 50));
					...
					case 'abstract':
						const abstract = alphaNum(
							(_e = item.fieldMap.get('abstract')) === null || _e === void 0
								? void 0
								: _e.value
						);
						const abs =
							abstract === null || abstract === void 0
								? void 0
		...
		if (sort) {
				...
				for (let key of sort) {
					...
					if (key === 'key') {
						...
						val = String(
							(_h =
								(_g =
									(_f = item.fieldMap) === null || _f === void 0
										? void 0
										: _f.get(key)) === null || _g === void 0
									? void 0
			...
			for (let i = sort.length - 1; i >= 0; i--) {
				...
				items.sort((a, b) => {
					...
					const ia =
						(_b =
							(_a = sortIndexes.get(a)) === null || _a === void 0
								? void 0
								: _a.get(key)) !== null && _b !== void 0
							? _b
							: '\ufff0';
					const ib =
						(_d =
							(_c = sortIndexes.get(b)) === null || _c === void 0
								? void 0
								: _c.get(key)) !== null && _d !== void 0
							? _d
							: '\ufff0';
