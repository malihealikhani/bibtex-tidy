(function (global, factory) {
	...
	const options = { 
		...
		align: { description: 'Insert whitespace between properties and values so that values are aligned', value: 13 },
		...
		stripComments: { description: 'Remove all comments', value: false }
	};
		...
		for (let entry of entries) {
			...
			if (entry.type === 'string') {
				...
				if (options.sortProperties) {
					let keyOrder = options.sortProperties;
